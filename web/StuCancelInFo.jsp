...
<!--                <div class="row align-items-center">
            ...
            <h1 class="text-center text-custom">Student Cancel Information</h1>
            <div class="row justify-content-center mt-5">
                <c:if test="${not empty requestScope.STUDENT_CANCEL_INFO}">
                    <table border="1" class="table table-hover table-primary table-rounded table-timetable-table">
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.STUDENT_CANCEL_INFO}" 
                                       var="booking" varStatus="status">
                                <tr>
                                    <td>${status.count}</td>
                                    <td>${booking.bookingID}</td>
                                    <td>${booking.studentID}</td>
                                    <td>${booking.lecturerID}</td>
                                    <td>${booking.lectureName}</td>
                                    <td>${booking.subjectCode}</td>
                                    <td>${booking.startTime}</td>
                                    <td>${booking.endTime}</td>
                                    <td>${booking.semesterID}</td>
                                </tr>
                            </c:forEach>
                        </tbody>
                    </table>
