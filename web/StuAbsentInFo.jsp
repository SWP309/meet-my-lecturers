...
<!--                <div class="row align-items-center">
            ...
            <h1 class="text-center text-custom">Student Absent Information</h1>
            <div class="row justify-content-center mt-5">
                <c:if test="${not empty requestScope.STUDENT_ABSENT_INFO}">
                    <table border="1" class="table table-hover table-primary table-rounded table-timetable-table">
                        ...
                        <tbody>
                            <c:forEach items="${requestScope.STUDENT_ABSENT_INFO}" 
