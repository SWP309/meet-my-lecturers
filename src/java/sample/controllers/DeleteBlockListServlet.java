 ...
 * @author W10
 */
public class DeleteBlockListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BlockListDTO blockListDTO = new BlockListDTO(lecturerID, studentID);
            boolean checkDelete = blockListDAO.deleteBlockList(blockListDTO);
            if (checkDelete) {
                url = SUCCESS;
            }
        } catch (Exception e) {
