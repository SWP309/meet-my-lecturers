 ...
 * @author W10
 */
public class UpdateBlockListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BlockListDTO blockListDTO = new BlockListDTO(lecturerID, studentID, Integer.parseInt(status));
            boolean checkUpdate = blockListDAO.updateBlockList(blockListDTO);
            if (checkUpdate) {
                url = SUCCESS;
            }
        } catch (Exception e) {
