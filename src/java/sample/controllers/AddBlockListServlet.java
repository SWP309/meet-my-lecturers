 ...
 * @author W10
 */
public class AddBlockListServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            BlockListDTO blockListDTO = new BlockListDTO(lecturerID, studentID, 1);
            boolean checkAdd = blockListDAO.addBlockList(blockListDTO);
            if (checkAdd) {
                url = SUCCESS;
            }
        } catch (Exception e) {
